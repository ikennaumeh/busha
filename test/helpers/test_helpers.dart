...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<CryptoService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockCryptoService getAndRegisterCryptoService() {
  _removeRegistrationIfExists<CryptoService>();
  final service = MockCryptoService();
  locator.registerSingleton<CryptoService>(service);
  return service;
}
// @stacked-mock-create
